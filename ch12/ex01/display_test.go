...
import (
	"gitlab.com/luyang93/The-Go-Programming-Language/ch07/eval"
	"io"
	"net"
	"os"
	"reflect"
...
func TestExample_slice(t *testing.T) {
...
func TestExample_nilInterface(t *testing.T) {
	var w io.Writer
	Display("w", w)
	// Output:
	// Display w (<nil>):
...
func TestExample_ptrToInterface(t *testing.T) {
	var w io.Writer
	Display("&w", &w)
	// Output:
	// Display &w (*io.Writer):
...
func TestExample_interface(t *testing.T) {
	var i interface{} = 3
	Display("i", i)
	// Output:
	// Display i (int):
...
func TestExample_ptrToInterface2(t *testing.T) {
	var i interface{} = 3
	Display("&i", &i)
	// Output:
	// Display &i (*interface {}):
...
func TestExample_array(t *testing.T) {
